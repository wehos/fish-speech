...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div style={{ width: '100%', textAlign: 'center', fontSize: 48, fontFamily: 'Inter', fontWeight: '800', wordWrap: 'break-word' }}>Fish speech</div>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left" style={{ textAlign: 'center' }}>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Finetune the model with your own data.
          </p>
        </Link>
